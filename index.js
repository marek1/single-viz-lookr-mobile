looker.plugins.visualizations.add({
    ...
    updateAsync: function(data, element, config, queryResponse, details, doneRendering) {
        ...
        // Adding further data
        let yoyValue = LookerCharts.Utils.filterableValueForCell(firstRow[qFields.dimension_like[config.yoyIndex].name.length > 0 ? qFields.dimension_like[config.yoyIndex].name : qFields.measure_like[config.yoyIndex].name]);
